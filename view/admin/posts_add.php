...
if(isset($_POST['addPosts'])){
    ...
    addPost($title, $content, $id_category,$thumbnail);
...
<div class="flex-1 p-10 text-2xl font-bold">
    ...
    <div class="flex-1 p-10">
        <div class="flex gap-5 items-center relative">
            <h2 class="text-4xl font-bold mb-4">Thêm bài viết</h2>
        ...
        <form action="" method="post" enctype="multipart/form-data">
                <div class="mb-6">
                    ...
                    <input name="title" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" id="title" type="text" placeholder="Tiêu đề">
                </div>
                <div class="mb-6">
                ...
                <div class="mb-6">
                    ...
                    <textarea name="content" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" id="content" rows="4" placeholder="Nhập đoạn giới thiệu tổng quan của bài đề anh em hiểu được nội dung bài viết..."></textarea>
                </div>
