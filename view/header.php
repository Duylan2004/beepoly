...
<head>
    ...
    <link rel="stylesheet" href="<?php echo $url?>view/css/my-account.css">
                    ...
                    <div class="login">
                        <?php
                            ...
                            if(isset($_SESSION['user'])){
                                ...
                                echo '<a class="my-account" href="'.$url.'my-account">'.$user["name"].'</a>';
                            }else{
                                echo '<a class="login_btn" href="'.$url.'signin">Đăng nhập</a>';
                            }
